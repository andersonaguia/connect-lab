...
import { checkWheater } from "../../utils/WheaterApi";

const handleClima = (city="João Pessoa", country="br") => {
    checkWheater(city, country)    
        .then((result) => {
    ...
    return(
        <SectionStyled>
            <H2Styled>Meu perfil</H2Styled>            
                ...
                <button onClick={()=> handleClima()}>Clima</button>                    
        </SectionStyled>
    )
}
